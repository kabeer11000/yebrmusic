...
module.exports = {
    ...
    searchYoutubeMultipleIdsFake: (ids, maxResults = 5) => "https://cdn.jsdelivr.net/gh/kabeer11000/sample-response/yt-api/videoIdSearch.json",
    ...
    DataCollectionServer: {
        CreateWatch: `${process.env.DATA_COLLECTION_SERVER}/api/history/create-watch`,
        /**
         *
         * @param id - user_id
         * @returns {string}
