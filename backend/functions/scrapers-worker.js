const node_endpoint = require("comlink/dist/umd/node-adapter.min");
 ...
 */
const searchYoutube = Comlink.proxy(async (query) => ytSearch({query: query}).then(videos => ({
    kind: "KabeersMusic#searchListResponse",
    etag: uuid.v4(),
    regionCode: "PK",
    pageInfo: {
